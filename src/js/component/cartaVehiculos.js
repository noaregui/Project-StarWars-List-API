                ...
                <div className="card" style={{ width: "18rem" }} key={vehiculo.uid}>
                    ...
                    <div className="card-body">
                        ...
                        <button class="fav" onClick={() => {
                            actions.añadirFavoritos(vehiculo.name); // Ejecuta la acción para añadir a favoritos
                            alert(`${vehiculo.name} has been added to your favorites ❤️`); // Muestra la alerta después de añadir a favoritos
                        }}>
