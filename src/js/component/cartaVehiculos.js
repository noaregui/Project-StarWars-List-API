...
export const CartaVehiculos = () => {
    ...
    const handleFav = (vehiculo) => {
        const favoritoExistente = store.favoritos.includes(vehiculo.name);
                        ...
                        <div className="card-body">
                            ...
                            <div className="like" title="Like">
                                <input
                                    type="checkbox"
                                    className="checkbox"
                                    id={`Give-It-An-Id-${vehiculo.uid}`}
                                    checked={store.favoritos.includes(vehiculo.name)}
                                    onChange={() => handleFav(vehiculo)}
                                />
                                <div className="svg-container">
                                    {store.favoritos.includes(vehiculo.name) ? (
