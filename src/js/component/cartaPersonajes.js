                ...
                <div className="card" style={{ width: "18rem" }} key={personaje.uid}>
                    ...
                    <div className="card-body">
                        ...
                        <button class="fav" onClick={() => {
                            actions.añadirFavoritos(personaje.name); // Ejecuta la acción para añadir a favoritos
                            alert(`${personaje.name} has been added to your favorites. The force is with you ✨ `); // Muestra la alerta después de añadir a favoritos
                        }}>
