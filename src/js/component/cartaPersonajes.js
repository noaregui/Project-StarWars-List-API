                        ...
                        <div className="card-body">
                            ...
                            <div className="like" title="Like">
                                <input
                                    type="checkbox"
                                    className="checkbox"
                                    id={`Give-It-An-Id-${personaje.uid}`} // Usar el uid del personaje en el ID
                                    onClick={() => {
                                        const favoritoExistente = store.favoritos.find((favorito) => favorito === personaje.name);

                                        if (favoritoExistente) {
                                            actions.eliminarFavoritos(personaje.name);
                                            alert(`${personaje.name} has been removed from your favorites.`);
                                        } else {
