                    ...
                    <div className="card" style={{ width: "18rem" }} key={planeta.uid}>
                        ...
                        <div className="card-body">
                            ...
                            <button class="fav" onClick={() => {
                                actions.añadirFavoritos(planeta.name); // Ejecuta la acción para añadir a favoritos
                                alert(`${planeta.name} has been added to your favorites ❤️`); // Muestra la alerta después de añadir a favoritos
                            }}>
