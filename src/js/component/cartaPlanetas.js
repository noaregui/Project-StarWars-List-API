                    ...
                    <div className="card" style={{ width: "18rem" }} key={planeta.uid}>
                        ...
                        <div className="card-body">
                            ...
                            <input
                                    type="checkbox"
                                    className="checkbox"
                                    id={`Give-It-An-Id-${planeta.uid}`} // Usar el uid del planeta en el ID
                                    onClick={() => {
                                        const favoritoExistente = store.favoritos.find((favorito) => favorito === planeta.name);

                                        if (favoritoExistente) {
                                            actions.eliminarFavoritos(planeta.name);
                                            alert(`${planeta.name} has been removed from your favorites.`);
                                        } else {
